...
-- SELECT track_id,source_id,creation_date,creation_datetime,detection_type,features FROM detection_in_memory
-- WHERE creation_date >= (SELECT ADDDATE(MIN(creation_date), INTERVAL 1 DAY) FROM detection_in_memory)
-- UNION ALL
-- SELECT track_id,source_id,creation_date,creation_datetime,detection_type,features FROM detection
-- WHERE creation_date < (SELECT ADDDATE(MIN(creation_date), INTERVAL 1 DAY) FROM detection_in_memory);
-- 
